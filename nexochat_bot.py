...
— Запускає / зупиняє nexochat_server.py
— /status — доступна всім
— Адмін-команди захищені логін/паролем (сесія 6 годин)
— /logs, /start_site, /stop_site, /restart_site, /proc_status
"""

import os, sys, time, json, signal, logging, threading, subprocess, hashlib
...
HELP_TEXT = (
    ...
    "/subscribe — алерти про падіння\n"
    "/unsubscribe — вимкнути алерти\n"
    "/my_id — твій chat_id\n\n"
    "<b>Адмін (потребує логіну):</b>\n"
...
# ── Notifications (викликається з server.py) ──────────────────────
...
if __name__ == "__main__":
    # Standalone режим: запускаємо сервер + бот разом
    log.info("Standalone: запускаю nexochat_server.py...")
